...
<div id="sidebar">
	<div class="sidebar bg-white">
		<div class="sidebar-inner">
			...
			<ul class="sidebar-menu scrollable position-relative pt-3 text-dark">
				...
				<li class="nav-item dropdown">
					<a class="nav-link wave-effect" href="<?php echo base_url('web') ?>">
						...
						<span class="title text-dark" id="spatitle">Dashboard</span>
					</a>
				</li>
				<?php 
				$level = $user['id_rule'];
				if ($level == 1) { ?>
					<li class="nav-item dropdown">
						<a class="nav-link wave-effect dropdown-toggle">
							...
							<span class="title text-dark" id="spatitle">Menu Kepala Departemen</span>
							<span class="arrow">
						...
						<ul class="dropdown-menu">
							<li>
								<a class="sidebar-link text-dark" href="<?php echo base_url('permohonan/datakaryawancuti') ?>">Data Permohonan Karyawan</a>
								<a class="sidebar-link text-dark" href="<?php echo base_url('overtime/overtimeKaryawan') ?>">Data Karyawan Overtime</a>		
							</li>
						</ul>
					</li>
				<?php } else if($level == 2) { ?>
					<li class="nav-item dropdown">
						<a class="nav-link wave-effect dropdown-toggle">
							...
							<span class="title text-dark" id="spatitle">Data Karyawan</span>
							<span class="arrow">
								<i class="fas fa-angle-right"></i>
							</span>
						</a>
						<ul class="dropdown-menu">
							<li>
								<a class="sidebar-link text-dark" href="<?php echo base_url('permohonan/datakaryawancuti') ?>">Data Permohanan Tidak Masuk Kerja</a>
								<a class="sidebar-link text-dark" href="<?php echo base_url('overtime/overtimeKaryawan') ?>">Data Permohonan Overtime</a>
							</li>
						</ul>
					</li>
					<li class="nav-item dropdown">
						<a class="nav-link wave-effect dropdown-toggle">
							...
							<span class="title text-dark" id="spatitle">Properti</span>
							<span class="arrow">
								<i class="fas fa-angle-right"></i>
							</span>
						</a>
						<ul class="dropdown-menu">
							<li>
								<a class="sidebar-link text-dark" href="<?php echo base_url('properti/jeniscuti/') ?>">Jenis Cuti Khusus</a>
								<a class="sidebar-link text-dark" href="<?php echo base_url('properti/jenispermohonan/') ?>">Jenis Permohonan Tidak Masuk Kerja</a>
								<a class="sidebar-link text-dark" href="<?php echo base_url('properti/jadwalkerja/') ?>">Jam Masuk Kerja</a>		
							</li>
						</ul>
					</li>
					<li class="nav-item dropdown">
						<a class="nav-link wave-effect dropdown-toggle">
							...
							<span class="title text-dark" id="spatitle">Work Schedule</span>
							<span class="arrow">
								<i class="fas fa-angle-right"></i>
							</span>
						</a>
						<ul class="dropdown-menu">
							<li>
								<a class="sidebar-link text-dark" href="<?php echo base_url('workschedule/workScheduleGrup') ?>">Tambah Schedule Grup</a>
								<a class="sidebar-link text-dark" href="<?php echo base_url('workschedule/workschedule_addperson') ?>">Tambah Person</a>
								<a class="sidebar-link text-dark" href="<?php echo base_url('workschedule/workschedule_person') ?>">Ubah Schedule Kerja Person</a>
								<a class="sidebar-link text-dark" href="<?php echo base_url('workschedule/workschedule_personHistory') ?>">History Change Person</a>		
							</li>
						</ul>
					</li>
				<?php } else{ ?>
					<li class="nav-item dropdown">
						<a class="nav-link wave-effect dropdown-toggle">
							...
							<span class="title text-dark" id="spatitle">Formulir</span>
							<span class="arrow">
								<i class="fas fa-angle-right"></i>
							</span>
						</a>
						<ul class="dropdown-menu">
							<li>
								<a class="sidebar-link text-dark" href="<?php echo base_url('permohonan/form_cuti') ?>">Formulir Permohonan</a>
								<a class="sidebar-link text-dark" href="<?php echo base_url('overtime/form_overtime') ?>">Formulir Permohonan Lembur</a>
							</li>
						</ul>
					</li>
					<li class="nav-item dropdown">
						<a class="nav-link wave-effect dropdown-toggle">
							...
							<span class="title text-dark" id="spatitle">Data Pribadi</span>
							<span class="arrow">
								<i class="fas fa-angle-right"></i>
							</span>
						</a>
						<ul class="dropdown-menu">
							<li>
								<a class="sidebar-link text-dark" href="<?php echo base_url('permohonan/datapribadicuti') ?>">Data Permohonan Pribadi</a>
								<a class="sidebar-link text-dark" href="<?php echo base_url('overtime/overtimePribadi') ?>">Data Lembur Pribadi</a>
							</li>
						</ul>
					</li>
				<?php } ?>
				<li class="nav-item dropdown">
					<a class="nav-link wave-effect dropdown-toggle">
						...
						<span class="title text-dark" id="spatitle">Mode Color</span>
						<span class="arrow">
							<i class="fas fa-angle-right"></i>
						</span>
					</a>
					<ul class="dropdown-menu">
						<li>
							<a class="sidebar-link text-dark" id="btn-dark" onclick="dark()" href="javascript:void(0)">Dark</a>
							<a class="sidebar-link text-dark" id="btn-light" onclick="light()" href="javascript: void(0)">Light</a>
							<a class="sidebar-link text-dark" id="btn-light" onclick="auto()" href="javascript: void(0)">Auto</a>		
						</li>
					</ul>
				</li>
			</ul>
...
<script>
	...
	function dark() {
		...
		document.querySelector('body.app').classList.add('bg-dark');
		document.querySelector('.sidebar').classList.remove('bg-white');
		document.querySelector('.sidebar').classList.add('bg-dark');
		document.querySelector('span.title').style.color = "white";
		document.querySelector('.fa-home').classList.remove('text-dark');
		document.querySelector('span.title').classList.remove('text-dark');
		document.querySelector('.fa-times-circle').classList.remove('text-dark');
		document.querySelector('ul.sidebar-menu').classList.remove('text-dark');
		const cion = document.getElementsByClassName('icon-holder');
		for(let i = 0; i < cion.length; i++){
			cion[i].style.color = 'white';	
		}
		const warnaColor = document.getElementsByClassName('text-dark');
		for(let i = 0; i < warnaColor.length; i++){
			warnaColor[i].style.color = 'white';	
		}
		const title = document.getElementsByClassName('title');
		for (var i = 0; i < title.length; i++) {
			title[i].classList.remove('text-dark');
		}
		const sidebarLink = document.getElementsByClassName('sidebar-link');
		for (var i = 0; i < sidebarLink.length; i++) {
			sidebarLink[i].classList.remove('text-dark');
		}
	}	
	function light() {
		document.querySelector('body.app').classList.remove('bg-dark');
		...
		document.querySelector('.fa-times-circle').classList.add('text-dark');
		document.querySelector('span.title').style.color = "#595053";
		const cion = document.getElementsByClassName('icon-holder');
		for(let i = 0; i < cion.length; i++){
			cion[i].style.color = '#595053';	
		}
		const title = document.getElementsByClassName('title');
		for (var i = 0; i < title.length; i++) {
			title[i].classList.add('text-dark');
		}
		const sidebarLink = document.getElementsByClassName('sidebar-link');
		for (var i = 0; i < sidebarLink.length; i++) {
			sidebarLink[i].classList.add('text-dark');
		}
	}
	function auto() {
		var tanggal = new Date().getHours();{}
		alert(tanggal);
	}
</script>
