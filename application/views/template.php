...
<head runat="server">
	...
	<link rel="stylesheet" href="<?php echo base_url('assets/css/next-sidebar2.css') ?>" />
	...
	<style>
		...
		.dropdown-content-body ul li.bg-fb1:hover {
			background-color: #3A3B3C;
			color: white;
		}
		...
		#calendargrup .fc-header-toolbar .fc-center h2 {
			color: #76838F !important;
		}

		#calendarPerson .fc-header-toolbar .fc-center h2 {
			color: #76838F !important;
		}

		.sidebar-menu .nav-item.open .nav-link .icon-holder {
	...
	<script src="<?php echo base_url('assets/') ?>animasijs/anime.min.js"></script>
...
<body class="app is-collapsed bg-white">
			...
			<div class="sidebar-inner">
				<div class="sidebar-logo">
					<div class="d-flex align-items-center flex-nowrap">
						<a class="sidebar-link text-decoration-none" href="javascript:void(0)">
							<div class="d-flex align-items-center flex-nowrap">
								<div class="logo-sm">
						...
						<div class="">
							<div class="mobile-toggle sidebar-toggle">
								<a href="javascript:void(0)" class="text-decoration-none">
									<i class="far fa-times-circle" style="color: #333333"></i>
								</a>
							</div>
						</div>
					</div>
				...
				<ul class="sidebar-menu scrollable position-relative pt-3" style="color: #333333">

					<li class="nav-item dropdown">
						<a class="nav-link wave-effect" href="<?php echo base_url('web') ?>">
							<span class="icon-holder">
								<i class="fas fa-home" style="color: #333333"></i>
							</span>
							<span class="title" style="color: #333333" id="spatitle">Dashboard</span>
						</a>
					</li>
					<li class="nav-item dropdown">
						<a class="nav-link wave-effect" href="<?php echo base_url('WorkSchedule/workCalendar') ?>">
							<span class="icon-holder">
								<i class="fas fa-home" style="color: #333333"></i>
							</span>
							<span class="title" style="color: #333333" id="spatitle">Create Work Calender</span>
						</a>
					</li>
					<?php
					$level = $user['id_rule'];
					if ($level == 1) { ?>
						<li class="nav-item dropdown">
							<a class="nav-link wave-effect dropdown-toggle">
								...
								<span class="title" style="color: #333333" id="spatitle">Menu Kepala Departemen</span>
								<span class="arrow">
							...
							<ul class="dropdown-menu">
								<li>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('permohonan/datakaryawancuti') ?>">Data Permohonan Karyawan</a>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('overtime/overtimeKaryawan') ?>">Data Karyawan Overtime</a>
								</li>
							</ul>
						</li>
					<?php } else if ($level == 2) { ?>
						<li class="nav-item dropdown">
							<a class="nav-link wave-effect dropdown-toggle">
								...
								<span class="title" style="color: #333333" id="spatitle">Data Karyawan</span>
								<span class="arrow">
									<i class="fas fa-angle-right"></i>
								</span>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('permohonan/datakaryawancuti') ?>">Data Permohanan Tidak Masuk Kerja</a>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('overtime/overtimeKaryawan') ?>">Data Permohonan Overtime</a>
								</li>
							</ul>
						</li>
						<li class="nav-item dropdown">
							<a class="nav-link wave-effect dropdown-toggle">
								...
								<span class="title" style="color: #333333" id="spatitle">Properti</span>
								<span class="arrow">
									<i class="fas fa-angle-right"></i>
								</span>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('properti/jeniscuti/') ?>">Jenis Cuti Khusus</a>
									<!-- <a class="sidebar-link" style="color: #333333" href="<?php echo base_url('properti/jenispermohonan/') ?>">Jenis Permohonan Tidak Masuk Kerja</a> -->
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('properti/jadwalkerja/') ?>">Jam Masuk Kerja</a>
								</li>
							</ul>
						</li>
						<li class="nav-item dropdown">
							<a class="nav-link wave-effect dropdown-toggle">
								...
								<span class="title" style="color: #333333" id="spatitle">Work Schedule</span>
								<span class="arrow">
									<i class="fas fa-angle-right"></i>
								</span>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('workschedule/workScheduleGrup') ?>">Tambah Schedule Grup</a>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('workschedule/workschedule_addperson') ?>">Tambah Person</a>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('workschedule/workschedule_person') ?>">Ubah Schedule Kerja Person</a>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('workschedule/workschedule_personHistory') ?>">History Change Person</a>
								</li>
							</ul>
						</li>
					<?php } else { ?>
						<li class="nav-item dropdown">
							<a class="nav-link wave-effect dropdown-toggle">
								...
								<span class="title" style="color: #333333" id="spatitle">Formulir</span>
								<span class="arrow">
									<i class="fas fa-angle-right"></i>
								</span>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('permohonan/form_cuti') ?>">Formulir Permohonan Cuti</a>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('overtime/form_overtime') ?>">Formulir Permohonan Lembur</a>
								</li>
							</ul>
						</li>
						<li class="nav-item dropdown">
							<a class="nav-link wave-effect dropdown-toggle">
								...
								<span class="title" style="color: #333333" id="spatitle">Data Pribadi</span>
								<span class="arrow">
									<i class="fas fa-angle-right"></i>
								</span>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('permohonan/datapribadicuti') ?>">Data Cuti Pribadi</a>
									<a class="sidebar-link" style="color: #333333" href="<?php echo base_url('overtime/overtimePribadi') ?>">Data Lembur Pribadi</a>
								</li>
							</ul>
						</li>
					<?php } ?>
					<li class="nav-item dropdown">
						<a class="nav-link wave-effect dropdown-toggle">
							<span class="icon-holder">
								<i id="modeC" class="fas fa-sun"></i>
							</span>
							<span class="title" style="color: #333333" id="spatitle">Mode Color</span>
							<span class="arrow">
								<i class="fas fa-angle-right"></i>
							</span>
						</a>
						<ul class="dropdown-menu">
							<li>
								<a class="sidebar-link" style="color: #333333" id="btn-dark" href="javascript:void(0)">Dark/Light</a>
								<a class="sidebar-link" style="color: #333333" id="btn-auto" href="javascript: void(0)">Auto</a>
							</li>
						</ul>
					</li>
				</ul>
	...
	<div class="container-wide">
				...
				<div class="header-right">
					<li class="icons dropdown ">
						<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
							<li><a href="javascript:void(0)" class="nav-link px-2 nama-user link-dark"><?= $user['Name'] ?></a></li>
							<li>
								<a href="javascript:void(0)" class="d-block link-dark text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
									<div class="dropdown-content-body">
										<ul>
											...
											<li class="border-atas-hitam"><a href="<?php echo base_url('auth/logout') ?>"><i class="fas fa-sign-out-alt"></i> <span>Sign Out</span></a></li>
										</ul>
									</div>
								</div>
							</li>
		...
		<div id="content" class="p-2 p-md-2">
			...
			<!-- Navbar -->
			<nav class="navbar navbar-expand-lg navbar-light bg-card" id="navbarNav" style="margin-bottom:7px;">
				<div class="container-fluid">
					...
					<!-- button togle  -->
					<button type="button" id="lingkaran" class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
						<i id="UpDown" class="fas fa-caret-down"></i>
						<span class="sr-only">Toggle Menu</span>
					</button>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							<li class="nav-item">
								<a class="nav-link active" aria-current="page" href="<?php echo base_url('web') ?>">Dashboard</a>
							</li>
							<?php
							$level = $user['id_rule'];
							if ($level == 1) { ?>
							...
							<?php } else { ?>
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
										<li><a class="dropdown-item" href="<?php echo base_url('permohonan/form_cuti') ?>">Formulir Permohonan Cuti</a></li>
								...
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
										<li><a class="dropdown-item" href="<?php echo base_url('permohonan/datapribadicuti') ?>">Data Cuti Pribadi</a></li>
			...
			<div class="rounded-3 table-responsive bg-card" id="containerCard" style="width:100%;padding:13px;">
			...
			<!-- footer original  -->
			<footer class=" flex-wrap justify-content-between align-items-center border-top mt-2">
				<p class="text-center pt-3">&copy; Copyright - 2021 Nippisun Indonesia</p>
			</footer>
		</div>
		<!-- sidebar js  -->
		...
		<!-- Kalender Kerja -->
		<script src="<?= base_url('assets/')?>js/workcalendar.js"></script>

		<!-- Animasi JS -->
		<script src="<?= base_url('assets/') ?>animasijs/custom.animasi.js"></script>

		<!-- Mode Dark -->
		<script src="<?= base_url("assets/") ?>mode/js/modedark.js"></script>

		<script>
			$(document).ready(function() {
				let mode = "<?= $this->session->userdata('mode') ?>";
				if (mode == 'dark') {
					dark();
				} else {
					light();
